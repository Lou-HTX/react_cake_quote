                    ...
                    <div className = "first-div">
                        <div id="thumbnail-slider">
                            <div className="inner">
                                <ul>
                                    <li>
                                        <img className = "thumb" src="../images/batman_cake.PNG" alt="Batman" width="1000" height="345"></img>
                                    </li>
                                    <li>
                                        <img className = "thumb" src="../images/bb-8.PNG" alt="bb-8" width="1000" height="345"></img>
                                    </li>
                                    <li>
                                        <img className = "thumb" src="../images/unicorn.PNG" alt="unicorn" width="1000" height="345"></img>
                                    </li>
                                    <li>
                                        <img className = "thumb" src="../images/cake_1.jpg" alt="Batman" width="1000" height="345"></img>
                                    </li>
                                    <li>
                                        <img className = "thumb" src="../images/cake_8.jpg" alt="bb-8" width="1000" height="345"></img>
                                    </li>
                                    <li>
                                        <img className = "thumb" src="../images/cake_3.jpg" alt="unicorn" width="1000" height="345"></img>
                                    </li>
                                    <li>
                                        <img className = "thumb" src="../images/cake_4.jpg" alt="Batman" width="1000" height="345"></img>
                                    </li>
                                    <li>
                                        <img className = "thumb" src="../images/cake_5.jpg" alt="bb-8" width="1000" height="345"></img>
                                    </li>
                                    <li>
                                        <img className = "thumb" src="../images/cake_6.jpg" alt="unicorn" width="1000" height="345"></img>
                                    </li>
                                    <li>
                                        <img className = "thumb" src="../images/cake_9.jpg" alt="Batman" width="1000" height="345"></img>
                                    </li>
                                </ul>
                            </div>
                        </div>
